...
echo "WRITER/ADMIN), then restart monitor-api and scm-docker-auth. Anyone holding"
echo "the old password -- including a 'docker login' session -- has to log in again."
